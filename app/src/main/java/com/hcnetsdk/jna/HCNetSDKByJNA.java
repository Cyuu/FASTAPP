...
public interface HCNetSDKByJNA extends Library {
    ...
    public static class NET_DVR_SINGLE_PLAN_SEGMENT extends Structure {
        ...
        public byte byVerifyMode; //0-invalid��1-dormant��2-item_card+password 3-item_card ��4-item_card or password��5-fingerprint��6-fingerprint and password��7-fingerprint or item_card��8-fingerprint and item_card��9-fingerprint and item_card and password
    ...
    public class NET_DVR_DEV_CHAN_INFO extends Structure {
        ...
        /**
         * Device type(Used by videoplatfom VCA item_card),
