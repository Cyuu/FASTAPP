 ...
 * 主页 光纤告警列表适配器
 */
public class FiberListAdapter extends BaseAdapter {

    private List<FiberBean> dataList = null;
    private Context context;

    public FiberListAdapter(Context context) {
        this.context = context;
    }

    public FiberListAdapter(Context context, List<FiberBean> dataList) {
        this.dataList = dataList;
        this.context = context;
    }

    public List<FiberBean> getDataList() {
        return dataList;
    }

    public void setDataList(List<FiberBean> dataList) {
        this.dataList = dataList;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_fiber, null);
        ...
        FiberBean bean = dataList.get(position);
