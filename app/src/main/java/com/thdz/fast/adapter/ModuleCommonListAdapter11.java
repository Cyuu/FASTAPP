 ...
 * 主页 业务列表适配器
 */
public class ModuleCommonListAdapter11 extends BaseAdapter {

    private List<ModuleCommonBean> dataList = null;
    private Context context;

    public ModuleCommonListAdapter11(Context context) {
        this.context = context;
    }

    public ModuleCommonListAdapter11(Context context, List<ModuleCommonBean> dataList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (hasAlarm) {
            holder.layout_bg.setBackgroundResource(R.drawable.bg_item_red);
            holder.item_module_count.setText(bean.getAlarmCount() + "个");

            holder.item_module_count.setTextColor(context.getResources().getColor(R.color.white));
            holder.item_module_name.setTextColor(context.getResources().getColor(R.color.white));
            holder.item_module_addr.setTextColor(context.getResources().getColor(R.color.white));
            ...
            holder.item_module_name.setTextColor(context.getResources().getColor(R.color.black));
            holder.item_module_addr.setTextColor(context.getResources().getColor(R.color.black));
