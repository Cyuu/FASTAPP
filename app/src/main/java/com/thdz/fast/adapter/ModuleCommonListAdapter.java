 ...
 * 主页 业务列表适配器
 */
public class ModuleCommonListAdapter extends BaseAdapter {

    private List<ModuleCommonBean> dataList = null;
    private Context context;

    public ModuleCommonListAdapter(Context context) {
        this.context = context;
    }

    public ModuleCommonListAdapter(Context context, List<ModuleCommonBean> dataList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (hasAlarm) {
            holder.layout_bg.setBackgroundResource(R.drawable.bg_item);
